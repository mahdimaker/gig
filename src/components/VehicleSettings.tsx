      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <section className="bg-zinc-950 border border-zinc-900 rounded-2xl p-6" id="vehicle-settings-form-panel">
            <div className="mb-5 flex items-center justify-between">
              <div>
                <h2 className="font-display font-semibold text-xl text-zinc-100 flex items-center gap-2">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2 sm:gap-3">
                  <button
                    ...
                    className={`p-3 rounded-xl border flex flex-col items-center justify-center gap-1.5 transition-all text-center cursor-pointer relative overflow-hidden group ${
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                        className="w-full bg-zinc-900/80 border border-zinc-800 text-zinc-200 pl-3 pr-20 py-2.5 rounded-xl text-sm focus:outline-none focus:border-emerald-500 font-mono"
                      />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-zinc-900/80 border border-zinc-800 text-zinc-200 pl-6 pr-12 py-2.5 rounded-xl text-sm focus:outline-none focus:border-emerald-500 font-mono"
                      />
                    ...
                    <span className="text-[10px] text-zinc-500 mt-1.5 block">Price of gas in your region</span>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-zinc-900/80 border border-zinc-800 text-zinc-200 pl-6 pr-10 py-2.5 rounded-xl text-sm focus:outline-none focus:border-emerald-500 font-mono"
                      />
                      <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[10px] font-semibold text-zinc-500">
                        /{distanceUnit === 'miles' ? 'mi' : 'km'}
                      </span>
                    </div>
                    <span className="text-[10px] text-zinc-500 mt-1.5 block">Wear, oil, tires, insurance</span>
                    ...
                    <div className="mt-4 space-y-2">
                      ...
                      <div className="grid grid-cols-3 gap-2 sm:gap-3">
                        <button
                          ...
                          className={`p-3 rounded-xl border flex flex-col items-center justify-center gap-1 transition-all text-center cursor-pointer relative overflow-hidden group ${
                            isEconomy
                        ...
                        >
                          ...
                          <span className="text-xs font-bold font-sans text-zinc-300 mt-1">Economy</span>
                          <span className="text-[10px] font-mono font-bold mt-0.5 text-blue-400">
                        ...
                        >
                          ...
                          <span className="text-xs font-bold font-sans text-zinc-300 mt-1">Standard</span>
                          <span className="text-[10px] font-mono font-bold mt-0.5 text-rose-400">
                        ...
                        >
                          ...
                          <span className="text-xs font-bold font-sans text-zinc-300 mt-1">Luxury</span>
                          <span className="text-[10px] font-mono font-bold mt-0.5 text-amber-400">
            ...
            <form onSubmit={handleSaveExpenseDefaults} className="space-y-4">
              <div className="space-y-2.5">
                ...
                <div className="bg-zinc-900/30 p-3.5 rounded-xl flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="block text-sm font-semibold text-zinc-200">Toll Rate</span>
                      <span className="block text-[10px] text-zinc-500">Standard bridge or highway tolls</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-1 bg-zinc-950/40 px-3 py-1.5 rounded-xl border border-zinc-900/80 focus-within:border-emerald-500/40 transition-all">
                    <span className="text-zinc-500 font-mono font-black text-xs select-none">{currencySymbol}</span>
                    <input
                      type="number"
                      step="0.01"
                      min="0"
                      ...
                      className="bg-transparent border-none text-emerald-400 font-mono font-black text-right text-sm focus:outline-none focus:ring-0 p-0 w-16"
                    />
                  </div>
                </div>
                ...
                <div className="bg-zinc-900/30 p-3.5 rounded-xl flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="block text-sm font-semibold text-zinc-200">Car Wash</span>
                      <span className="block text-[10px] text-zinc-500">Routine shift preparation wash</span>
                    </div>
                  </div>
                ...
                <div className="bg-zinc-900/30 p-3.5 rounded-xl flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="block text-sm font-semibold text-zinc-200">Standard Parking</span>
                      <span className="block text-[10px] text-zinc-500">Average metered space or garage fee</span>
                    </div>
                  </div>
                ...
                {customButtons.map((btn) => (
                  <div key={btn.id} className="bg-zinc-900/30 p-3.5 rounded-xl flex items-center justify-between gap-4 border border-dashed border-zinc-800/40">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <span className="block text-sm font-semibold text-zinc-200">{btn.label}</span>
                        <span className="block text-[10px] text-zinc-500">Custom tap button (linked to {btn.category})</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="text-zinc-500 hover:text-rose-400 p-1 rounded-lg hover:bg-zinc-900 transition-all cursor-pointer"
              ...
              {!showAddCustomForm ? (
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-xl border border-dashed border-zinc-800 hover:border-zinc-700 bg-zinc-950/40 hover:bg-zinc-900/30 text-zinc-400 hover:text-zinc-200 text-xs font-semibold flex items-center justify-center gap-2 transition-all cursor-pointer active:scale-[0.98]"
                >
                ...
                <div className="bg-zinc-900/40 border border-zinc-800 p-4 rounded-xl space-y-3.5">
                  <div className="flex justify-between items-center pb-1 border-b border-zinc-800/40">
                    <span className="text-xs font-bold text-zinc-300 uppercase tracking-wider">New Custom Quick Button</span>
                    <button
                      type="button"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-[10px] font-medium text-zinc-400 mb-1">Button Label</label>
                      <input
                        type="text"
                        required
                        ...
                        className="w-full bg-zinc-950 border border-zinc-800 text-zinc-200 px-3 py-2 rounded-lg text-xs focus:outline-none focus:border-emerald-500"
                      />
                    </div>
                    <div>
                      <label className="block text-[10px] font-medium text-zinc-400 mb-1">Default Cost</label>
                      <div className="relative">
                        <span className="absolute left-2.5 top-1/2 -translate-y-1/2 text-zinc-500 font-mono font-bold text-xs select-none">
                          {currencySymbol}
                        </span>
                        <input
                          type="number"
                          ...
                          className="w-full bg-zinc-950 border border-zinc-800 text-zinc-200 pl-6 pr-3 py-2 rounded-lg text-xs focus:outline-none focus:border-emerald-500 font-mono"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <label className="block text-[10px] font-medium text-zinc-400 mb-1">Accounting Category Link</label>
                    <select
                      value={customCategory}
                      onChange={(e) => setCustomCategory(e.target.value as any)}
                      className="w-full bg-zinc-950 border border-zinc-800 text-zinc-200 px-2.5 py-2 rounded-lg text-xs focus:outline-none focus:border-emerald-500"
                    >
              ...
              <div className="pt-3 border-t border-zinc-900 flex flex-col items-center gap-2">
                ...
                <button
                  type="submit"
                  className="w-full bg-zinc-900 hover:bg-zinc-800 text-emerald-400 border border-zinc-800 py-3 px-6 rounded-xl text-xs font-bold transition-all shadow active:scale-[0.98] cursor-pointer text-center uppercase tracking-wider"
                >
        ...
        <div className="lg:col-span-1 space-y-6">
          <section className="bg-zinc-950 border border-zinc-900 rounded-2xl p-5 space-y-5" id="maintenance-settings-panel">
            <div>
              <h3 className="font-display font-semibold text-sm text-zinc-200 uppercase tracking-wider">
                System Calculations
              </h3>
            ...
            <div className="bg-zinc-900/25 border border-zinc-900 p-4 rounded-xl space-y-2 text-xs text-zinc-400 leading-relaxed">
              <h4 className="font-semibold text-zinc-300 text-[11px] uppercase tracking-wider flex items-center gap-1">
                <Info className="w-3.5 h-3.5 text-emerald-400" /> Formulas Used:
              </h4>
              <p>
                <span className="font-mono text-[10px] block text-amber-500">Fuel Cost = </span>
                {distanceUnit === 'miles' 
                  ? '(Miles Driven / MPG) * Fuel Price' 
                  : '(Km Driven / 100) * L/100km * Fuel Price'
                }
              </p>
              <p className="border-t border-zinc-900 pt-1.5">
                <span className="font-mono text-[10px] block text-orange-400">Wear/Depreciation Cost = </span>
                Distance * Wear rate
              </p>
            </div>
          ...
          <section className="bg-zinc-950 border border-zinc-900 rounded-2xl p-5 space-y-4" id="calibration-history-panel">
            <div>
              <h3 className="font-display font-semibold text-sm text-zinc-200 uppercase tracking-wider flex items-center gap-2">
            ...
            <div className="space-y-2 max-h-[190px] overflow-y-auto pr-1">
              {!profile.fuelPriceHistory || profile.fuelPriceHistory.length === 0 ? (
                <div className="text-center py-6 text-zinc-600 text-xs border border-dashed border-zinc-900 rounded-xl">
                ...
                [...profile.fuelPriceHistory].reverse().map((entry, index) => {
                  ...
                  return (
                    <div 
                      key={index} 
                      className="flex items-center justify-between p-2.5 bg-zinc-900/40 border border-zinc-900/50 rounded-xl text-xs"
                    >
                      <div className="flex flex-col">
                        <span className="font-mono text-[10px] text-zinc-500">{formattedDate}</span>
                        <span className="text-zinc-300 font-medium">Fuel price adjustment</span>
                      </div>
                      <span className="font-mono font-bold text-emerald-400">
                        {formatCurrency(entry.price, profile)}<span className="text-[10px] font-normal text-zinc-500">/{profile.fuelUnit === 'gallons' ? 'gal' : 'L'}</span>
                      </span>
                    </div>
                  );
                })
